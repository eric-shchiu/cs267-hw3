...
HashMap::HashMap(size_t size) {
    ...
    local_size = (size + num_ranks - 1) / num_ranks;
    ...
    ad = upcxx::atomic_domain<int>({upcxx::atomic_op::compare_exchange, upcxx::atomic_op::fetch_add}, upcxx::world());

    // Broadcast loop (can keep the .wait() here, it's part of setup)
